...
CREATE TABLE "instrumentfilter" (
  ...
  "action_on_record" tinyint NOT NULL,
...
CREATE UNIQUE INDEX ON "positions" ("position_id", "trading_acct", "client_id");

CREATE UNIQUE INDEX ON "accountfilter" ("line", "account");

CREATE UNIQUE INDEX ON "instrumentfilter" ("path", "product", "exchange", "instrument");
